...
# send_message is metadata describing the `send_message` tool
# that is included in our llm requests.
send_message_schema = {
    "type": "function",
    "function": {
        "name": "send_message",
...
# inboxes is where are sent messages are stored.
# it's a dict that maps recipient to a list of received messages
inboxes = {}
...
# print_context is a convenience function used to display
